...
/**
 * Marketplace sub-tab (SET.5): a search input over the (mock) catalog with result
 * cards and a skeleton while loading. Empty query lists the full catalog. Install
 * isn't wired — the card's Install button surfaces that it arrives with the
 * marketplace backend.
 */
  ...
  return (
    <div className="space-y-4">
      <div className="relative">
        ...
        <Input
          value={query}
          placeholder="Search the skill marketplace…"
          autoComplete="off"
          className="pl-8"
            ...
            >
              <div className="min-w-0 flex-1 space-y-1">
                ...
                <p className="text-[10px] text-muted-foreground">
                  {skill.author} · {numberFmt.format(skill.installs)} installs
                </p>
              </div>
              <Button
                type="button"
